...
function ChartTooltipContent({
  ...
  formatter?: (value: unknown, name: string, ...args: unknown[]) => string | React.ReactNode
  color?: string
  nameKey?: string
  labelKey?: string
}) {
    ...
    if (labelFormatter) {
      return (
        <div className={cn('font-medium', labelClassName)}>
          {labelFormatter(value as unknown, payload)}
        </div>
      )
    }
...
function ChartLegendContent({
  ...
  const payloadArray = payload as unknown[] | undefined
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                ...
                style={{
                  backgroundColor: String(itemObj.color),
                }}
              />
            )}
            {itemConfig?.label}
